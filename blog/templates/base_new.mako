                    ...
                    <div class="" id="post-${entry.id}">
                        ...
                        <div class="post-title">
                            ...
                            <span class="post-categories">
                                in <a href="/?category=${urllib.quote(entry.category.name.encode('utf8'))}" title="">${entry.category.name}</a>
                            </span>
                            <span class="post-categories">
                                taged as 
                                %for i in range(len(entry.tags)):
                                <% tag=entry.tags[i] %>
                                <a href="/?tag=${urllib.quote(tag.name.encode('utf8'))}">${tag.name}</a>
    ...
    customSearchControl.draw('cse');
                                ...
                                <ul>
                                    ...
                                    <%
                                        import urllib
                                    %>
                                    <li class="cat-item"><a href="/?category=${urllib.quote(category.name.encode('utf8'))}" title="${category.name}">${category.name}</a>
                                    (${category.postcount})
                                    </li>
                                    %endfor
                                </ul>
